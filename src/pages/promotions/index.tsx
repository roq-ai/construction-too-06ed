...
function PromotionListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('promotion', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/promotions/view/${id}`);
    }
  };
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        {hasAccess('promotion', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
          <Flex justifyContent="space-between" mb={4}>
            ...
            <NextLink href={`/promotions/create`} passHref legacyBehavior>
