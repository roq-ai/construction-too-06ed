      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl id="discount_percentage" mb="4" isInvalid={!!formik.errors?.discount_percentage}>
              ...
              {formik.errors.discount_percentage && (
                <FormErrorMessage>{formik.errors?.discount_percentage}</FormErrorMessage>
              )}
            </FormControl>
