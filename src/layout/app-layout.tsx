...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Outlet', path: '/outlets', entity: 'outlet', service: AccessServiceEnum.PROJECT, icon: FiShoppingBag },
    {
      name: 'Promotion',
      path: '/promotions',
      entity: 'promotion',
    ...
    { name: 'Tool', path: '/tools', entity: 'tool', service: AccessServiceEnum.PROJECT, icon: FiTool },
